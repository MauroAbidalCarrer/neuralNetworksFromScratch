...
class Layer:
    ...
    def __init__(self, input_size, nb_neurons, debug_layer_index, L2_weights_multiplier=0, L2_biases_multiplier=0, logs_file=None, activation_function=Linear()):
        ...
        self.weights = 0.01 * np.random.randn(input_size, nb_neurons)
